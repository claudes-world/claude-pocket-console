...
type CompactModal = null | "confirm";
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <button
                onClick={() => sendCompactCommand(
                  "Before compacting, please ensure: 1) README.md is up to date with recent changes. 2) Anything important from this session is saved to the knowledge base or memory. 3) Open work and next steps are captured in NEXT-SESSION.md and TODO.md. Then run /compact."
                )}
                style={{
                  ...btnStyle,
                  background: "#1a3a2a",
